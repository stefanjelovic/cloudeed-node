...
// const updateUserForgetToken = async (token,userId) => {    
//     [err, user] = await to(User.update({ forget_password:token },{ _id : userId } )); 
//     console.log('OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO');
//     console.log(err);
//     console.log(user);
//     console.log('OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO');
// }
// module.exports.updateUserForgetToken = updateUserForgetToken;
